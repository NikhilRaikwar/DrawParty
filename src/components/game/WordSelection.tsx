...
export const WordSelection = ({ words, onSelect }: WordSelectionProps) => {
  return (
    <div className="fixed inset-0 bg-foreground/80 backdrop-blur-sm flex items-center justify-center z-50 animate-slide-up">
      <div className="bg-card p-8 rounded-2xl shadow-2xl max-w-lg w-full mx-4">
        <h2 className="text-2xl font-bold text-center mb-2">Choose a Word</h2>
        ...
        <div className="grid gap-3">
          {words.map((word, index) => (
            <Button
              ...
              size="lg"
              className={cn(
                "h-16 text-xl font-semibold hover:scale-105 transition-all",
